...
#define BUTTON_VER_MAJOR (2)
#define BUTTON_VER_MINOR (5)
#define BUTTON_VER_PATCH (6)
 ...
 *
 */
typedef enum { BUTTON_TYPE_GPIO, BUTTON_TYPE_ADC, BUTTON_TYPE_CUSTOM } button_type_t;
...
typedef struct
{
    ...
    void *priv; /**< private data used for custom button, MUST be allocated dynamically and will be auto freed in
                   iot_button_delete*/
